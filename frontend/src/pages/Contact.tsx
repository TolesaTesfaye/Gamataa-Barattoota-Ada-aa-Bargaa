...
export default function Contact() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 space-y-6 sm:space-y-8 py-4 sm:py-6 pb-6">
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 dark:from-blue-700 dark:to-blue-900 text-white rounded-xl sm:rounded-2xl p-6 sm:p-10 md:p-12 text-center shadow-lg">
        <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold mb-2 sm:mb-4">Nu Qunnami</h1>
        <p className="text-sm sm:text-lg md:text-xl text-blue-100">Gaaffii yoo qabaattan ykn wanni nu bira akka ga&apos;u yoo barbaaddan nu qunnamaa.</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
        <div className="space-y-4 sm:space-y-6 order-2 lg:order-1">
          {contactInfo.map((info) => (
            <div key={info.title} className="bg-white dark:bg-gray-800 p-5 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg dark:shadow-gray-900/50 border border-gray-100 dark:border-gray-700">
              <div className="flex items-start gap-4">
                <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl bg-blue-100 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 flex items-center justify-center flex-shrink-0">
                  {info.icon}
                </div>
                <div className="min-w-0">
                  <h3 className="font-bold text-gray-900 dark:text-gray-100 mb-1">{info.title}</h3>
                  {info.href ? (
                    <a href={info.href} className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition text-sm break-words">
                      {info.value}
                    </a>
                  ) : (
          ...
          <div className="bg-white dark:bg-gray-800 p-5 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg dark:shadow-gray-900/50 border border-gray-100 dark:border-gray-700">
            ...
            <div className="flex gap-3">
              {socialLinks.map((s) => (
                <a
                  ...
                  href="#"
                  aria-label={s.label}
                  className={`w-11 h-11 touch-target rounded-xl bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 flex items-center justify-center font-bold text-xs uppercase tracking-wider transition-all ${s.color} hover:text-white dark:hover:text-white`}
                >
                  {s.icon}
                </a>
              ))}
        ...
        <div className="lg:col-span-2 order-1 lg:order-2">
          <div className="bg-white dark:bg-gray-800 p-5 sm:p-8 rounded-xl sm:rounded-2xl shadow-lg dark:shadow-gray-900/50 border border-gray-100 dark:border-gray-700">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">Ergii Nuuf Ergi</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-300 dark:border-gray-600 rounded-xl px-4 py-3 min-h-[48px] text-base bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 transition"
              ...
              <div>
                ...
                <select
                  ...
                  value={formData.type}
                  onChange={handleChange}
                  className="w-full border border-gray-300 dark:border-gray-600 rounded-xl px-4 py-3 min-h-[48px] text-base bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 transition"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={6}
                  className="w-full border border-gray-300 dark:border-gray-600 rounded-xl px-4 py-3 min-h-[48px] text-base bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 transition resize-y"
