    ...
    return (
      <div className="min-h-screen bg-gray-950 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/students" className="inline-block mt-4 text-teal-400 hover:text-teal-300 underline">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl dark:shadow-gray-900/50 overflow-hidden">
          <div className="md:flex">
            <div className="md:w-80 p-8 flex flex-col items-center bg-gradient-to-b from-teal-50 to-white dark:from-teal-900/30 dark:to-gray-800 border-b md:border-b-0 md:border-r border-gray-200 dark:border-gray-700">
              ...
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white text-center">{student.name}</h1>
              <div className="flex items-center gap-2 mt-2">
                <span className="px-3 py-1 rounded-full bg-teal-100 dark:bg-teal-900/50 text-teal-700 dark:text-teal-300 text-xs font-medium">{student.role}</span>
                <span className="px-3 py-1 rounded-full bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 text-xs font-medium">Batch {student.entry}</span>
              </div>
            </div>
            ...
            <div className="flex-1 p-6 sm:p-8 space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-xs text-gray-500 dark:text-gray-500 uppercase tracking-wider">Qorannoo</p>
                    <p className="text-gray-900 dark:text-gray-200 text-sm font-medium">{student.field}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-xs text-gray-500 dark:text-gray-500 uppercase tracking-wider">Ganda</p>
                    <p className="text-gray-900 dark:text-gray-200 text-sm font-medium">{student.village}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-xs text-gray-500 dark:text-gray-500 uppercase tracking-wider">Mana Barumsaa</p>
                    <p className="text-gray-900 dark:text-gray-200 text-sm font-medium">{student.school}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-xs text-gray-500 dark:text-gray-500 uppercase tracking-wider">Waggaa</p>
                    <p className="text-gray-900 dark:text-gray-200 text-sm font-medium">{student.year}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                <div className="flex flex-wrap gap-6">
                  <div>
                    <p className="text-xs text-gray-500 dark:text-gray-500 uppercase tracking-wider">Bilbilaa</p>
                    <a href={`tel:${student.phone}`} className="text-teal-600 dark:text-teal-400 hover:underline text-sm font-medium">
                      {student.phone}
                    </a>
                  </div>
                  {student.email && (
                    <div>
                      ...
                      <a href={`mailto:${student.email}`} className="text-teal-600 dark:text-teal-400 hover:underline text-sm font-medium break-all">
                        {student.email}
                      </a>
                    </div>
                  )}
                  {student.telegram && (
                    <div>
                      <p className="text-xs text-gray-500 dark:text-gray-500 uppercase tracking-wider">Telegram</p>
                      <span className="text-gray-900 dark:text-gray-200 text-sm font-medium">{student.telegram}</span>
                    </div>
                  )}
                </div>
              </div>
