      ...
      <div className="w-full max-w-md relative">
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-2xl rounded-3xl shadow-[0_8px_40px_rgba(0,0,0,0.06)] dark:shadow-[0_8px_40px_rgba(0,0,0,0.3)] border border-white/50 dark:border-gray-700/50 p-8 sm:p-10 transition-all duration-300">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-2 text-sm sm:text-base">Sign in to your account to continue</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-end">
              <Link to="/login" className="text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors">Forgot Password?</Link>
            </div>
          ...
          <p className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
            ...
            <Link to="/register" className="font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors">Register</Link>
          </p>
        </div>
      </div>
    </div>
