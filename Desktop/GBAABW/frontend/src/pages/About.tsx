...
export default function About() {
  ...
  const values = [
    ...
    {
      title: "Excellence",
      desc: "We strive for exceptional quality in every initiative and program we undertake.",
      icon: (
        <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    {
      title: "Unity",
      desc: "We believe in the power of collective effort and building strong partnerships.",
      icon: (
        <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    {
      title: "Service",
      desc: "We are committed to serving our members and the wider Ghanaian community.",
      icon: (
        <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    {
      title: "Leadership",
      desc: "We develop and empower leaders who inspire change and drive progress.",
      icon: (
        <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    {
      title: "Diversity",
      desc: "We embrace diverse perspectives and ensure equal opportunities for all.",
      icon: (
        <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  const milestones = [
    { year: "1990", title: "Founded", desc: "GBAABW was established by a group of visionary Ghanaian legal professionals in the UK, laying the foundation for a strong community." },
    { year: "2000", title: "First Office", desc: "Opened our first permanent office in London, providing a dedicated space for members to meet, collaborate, and access resources." },
    { year: "2010", title: "Chartered", desc: "Received our Royal Charter of Incorporation, formally recognizing GBAABW as a distinguished professional body." },
    { year: "2018", title: "Digital Transformation", desc: "Launched our digital platform and virtual services, expanding access to members across the UK and beyond." },
    { year: "2025", title: "35th Anniversary", desc: "Celebrated 35 years of serving the Ghanaian legal community, with over 2,000 active members and growing." },
  ]
    ...
    <div className="min-h-screen bg-gray-950 text-gray-100">
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-700 via-indigo-800 to-purple-900 py-24 px-4">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-200 max-w-2xl mx-auto leading-relaxed">
            Connecting, empowering, and representing Ghanaian legal professionals in the United Kingdom since 1990.
          </p>
        </div>
        ...
        >
          <div className="bg-gradient-to-br from-blue-600/20 to-blue-900/20 border border-blue-500/20 rounded-2xl p-8 md:p-10 backdrop-blur-sm hover:border-blue-400/40 transition-colors">
            ...
            <p className="text-gray-300 leading-relaxed text-lg">
              To empower Ghanaian legal professionals in the UK with the resources, networks, and opportunities they need to excel in their careers and make a positive impact in their communities.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-indigo-600/20 to-indigo-900/20 border border-indigo-500/20 rounded-2xl p-8 md:p-10 backdrop-blur-sm hover:border-indigo-400/40 transition-colors">
            ...
            <h2 className="text-3xl font-bold text-indigo-300 mb-4">Our Vision</h2>
            <p className="text-gray-300 leading-relaxed text-lg">
              A world where every Ghanaian legal professional has access to the support, connections, and opportunities necessary to achieve their full potential and drive collective progress.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          >
            Key milestones from our rich history
          </p>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-700 via-indigo-800 to-purple-900 py-20 px-4">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-200 mb-8">
            Become part of a thriving network of Ghanaian legal professionals in the UK.
          </p>
          <Link
            to="/register"
